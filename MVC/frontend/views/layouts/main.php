...
<head>
    <link rel="shortcut icon" href="assets/images/logo-banh.png" type="image/png" />
    <meta charset="utf-8" />
        ...
        {$_SESSION['success']}
            ...
            <footer class="footer">
                        ...
                        <div class="row">
                            <div class="col-md-4 wow slideInLeft">
                                <div class="content-register-news">
                                    ...
                                    <p>Để cập nhật những thông tin mới nhất về Dola - Bakery</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="coppyright">
                    <p>Copyright &copy; 2022 Dola - Bakery. <a target='_blank' href='https://sv.dhcnhn.vn/'>Powered by NL</a>.</p>
                </div>
            </footer>
