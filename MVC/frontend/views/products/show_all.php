                                    ...
                                    <div class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 wow fadeInUp animation rainbow_0">
                                        <div class="product-item product-resize clearfix">
                                            ...
                                            <div class="right-block product-detail">
                                                ...
                                                <p class="pro-vendor">
                                                    Thương hiệu: <span><?php echo  $product['supplier']; ?></span>
                                                </p>
            ...
            <form action="" method="post" <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pull-left">
                ...
                <div class="sidebar_price list-group">
                    ...
                    <ul class="nav navs sidebar menu" id='cssmenu'>
                        ...
                        <li class="item  first">
                            <a>
                                <input type="checkbox" name="price[]" value="1" <?php echo $checked_price1; ?>> Dưới 50,000
                            </a>
                        </li>
                        <li class="item">
                            <a>
                                <input type="checkbox" name="price[]" value="2" <?php echo $checked_price2; ?>> 50,000 - 100,000
                            </a>
                        </li>
                        <li class="item">
                            <a>
                                <input type="checkbox" name="price[]" value="3" <?php echo $checked_price3; ?>> 100,000 - 200,000
                            </a>
                        </li>
                        <li class="item ">
                            <a>
                                <input type="checkbox" name="price[]" value="4" <?php echo $checked_price4; ?>> 200,000 - 250,000
                            </a>
                        </li>
                        <li class="item  last">
                            <a>
                                <input type="checkbox" name="price[]" value="5" <?php echo $checked_price5; ?>> Trên 250,000
                            </a>
                        </li>
                    </ul>
