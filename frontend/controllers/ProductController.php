        ...
        if (isset($_POST['filter'])) {
            ...
            if (isset($_POST['price'])) {
                foreach ($_POST['price'] as $price) {
                    switch ($price) {
                        case 1:
                            $str_price .= " OR products.price < 50000";
                            break;
                        case 2:
                            $str_price .= " OR products.price BETWEEN 50000 AND 100000";
                            break;
                        case 3:
                            $str_price .= " OR products.price BETWEEN 100000 AND 200000";
                            break;
                        case 4:
                            $str_price .= " OR products.price BETWEEN 200000 AND 250000";
                            break;
                        case 5:
                            $str_price .= " OR products.price > 250000";
                            break;
                    }
                }
